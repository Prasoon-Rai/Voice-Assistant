...
# You can enter the name of the Assistant here -->
    ...
    if __name__ == '__main__':
        ...
        if 'open youtube' in query:
         ...
         AI was designed by a solo developer, Prasoon rai.
            For more information just say 'more information' or 'information'.
            ...
            4. I can tell you some of my most amazing features here -
             ...
             at his G-mail ID  arenodev.python@gmail.com) and you will get a responce from him under 5 days with basic codes...
            ...
            webbrowser.open("https://areno-dev.github.io/arenodev/")
